...
public class UnitTest23 extends BaseTest {

	String expectedFilePath = System.getProperty("user.dir") + "/src/test-data/unit-tests/KnowledgeKing_IncorrectAnswer.out";
	...
	public void test() throws IOException {
		...
		waterballCommunity.newMessage("1", "D", new String[] {"botImpl"});
