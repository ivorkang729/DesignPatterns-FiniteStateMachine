...
public class UnitTest18 extends BaseTest {

	String expectedFilePath = System.getProperty("user.dir") + "/src/test-data/unit-tests/KnowledgeKing_StartByAdmin.out";
	...
	public void setUp() throws Exception {
		...
		bot = BotFactory.createBot(waterballCommunity, "2023-08-07 00:00:00", 5);
