...
public class UnitTest20 extends BaseTest {

	String expectedFilePath = System.getProperty("user.dir") + "/src/test-data/unit-tests/KnowledgeKing_CorrectAnswer_FirstUser.out";
