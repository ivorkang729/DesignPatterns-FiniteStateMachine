...
public class UnitTest09 extends BaseTest {

	String expectedFilePath = System.getProperty("user.dir") + "/src/test-data/unit-tests/Forum_BotComment_InteractiveState.out";
	...
	public void test() throws IOException {
		...
		waterballCommunity.newPost("201", "10", "Interactive Post", "Testing interactive forum", new String[] {});
